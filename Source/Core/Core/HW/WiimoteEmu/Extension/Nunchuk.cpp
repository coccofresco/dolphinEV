...
void Nunchuk::BuildDesiredExtensionState(DesiredExtensionState* target_state)
{
  ...
  if (Common::VR::IsEnabled() && 0)
  {
    ...
    Common::VR::GetControllerOrientation(0, m_tilt_state.angle.x, m_tilt_state.angle.y,
    ...
    Common::VR::GetControllerTranslation(0, m_swing_state.position.x, m_swing_state.position.y,
